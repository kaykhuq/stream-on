          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header  d-flex justify-content-start">
                ...
                <h2 className="pt-4">{this.props.action} {this.props.type}</h2>
              </div>
              <form onSubmit={this.onSubmit}>
                <div className="modal-body">
                  ...
                  <div className="form-group">
                    <label className="d-flex justify-content-start">Select sites</label>
                    <select id="select_sites" className="form-control text-muted select_multiple">
                      <option value="0" defaultValue>select a site...</option>
